frappe.pages['cash-out'].on_page_load = function(wrapper) {
...
PageContent = Class.extend({
    ...
    init: function(wrapper) {
		...
		// if (frappe.get_route()[0] === 'cash-out') {
			...
			<div class="layout-main-section-wrapper">
				<div class="layout-main-section layout-main-list">
					...
					<div class="frappe-list">
						<div class="result" style="height: 544px">
    ...
    load_data: function() {
		...
		frappe.call({
			method: 'remittance.remittance.page.cash_out.cash_out.get_cashout_trans',
			args: {
